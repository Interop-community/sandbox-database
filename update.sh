...
docker build -t ${ACCOUNT}.dkr.ecr.us-east-1.amazonaws.com/interop/sandbox-mysql:kube .
...
docker push ${ACCOUNT}.dkr.ecr.us-east-1.amazonaws.com/interop/sandbox-mysql:kube
